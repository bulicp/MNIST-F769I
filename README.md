...
## 8. **Generating a Quantized MNIST Test Subset for STM32 Testing**
...
## 9. Initializing and Running a Neural Network on STM32F769I with Cube.AI

Now, we’ll walk through setting up and running a neural network on the STM32F769I using STM32Cube.AI. Below are the necessary variables you’ll need to declare in `main.c` and explanations of each.
